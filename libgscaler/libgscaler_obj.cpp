...
bool CGscaler::m_gsc_check_src_size(
    unsigned int *w,
    unsigned int *h,
    __attribute__ ((unused)) unsigned int *crop_x, 
    __attribute__ ((unused)) unsigned int *crop_y,
    unsigned int *crop_w,
    unsigned int *crop_h,
    __attribute__ ((unused)) int v4l2_colorformat)
{
...
bool CGscaler::m_gsc_check_dst_size(
    ...
    unsigned int *crop_h,
    __attribute__ ((unused)) int v4l2_colorformat,
    __attribute__ ((unused)) int rotation)
{
